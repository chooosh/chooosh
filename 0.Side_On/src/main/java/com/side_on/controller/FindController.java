...
public class FindController {
	...
	/**
	@RequestMapping("/find/findListTest")
	public String findMemberTest(Model model) {
		List<Find> testList = findService.findMemberListTest();
		model.addAttributes("testList", testList);
		return "find/findListTest";
	}
	*/
